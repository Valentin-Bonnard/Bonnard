    ...
    public class BaseController : Controller
    {
        ...
        protected override void ExecuteCore()
        {
            ...
            else
            {
                ...
                var cookie = HttpContext.Request.Cookies["Bonnard.CurrentUICulture"];
            ...
            HttpCookie _cookie = new HttpCookie("Bonnard.CurrentUICulture", Thread.CurrentThread.CurrentUICulture.Name);
